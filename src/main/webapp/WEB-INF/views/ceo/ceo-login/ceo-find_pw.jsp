...
<head>
    <meta charset="UTF-8">
    <title>업주 비밀번호 찾기</title>
    <link rel="stylesheet" href="ceo-find-pw.css">
</head>
<body>
    <div class="wrap">
        <label for="find_id">비밀번호 찾기</label>
        <div id="f_phone" class="find">
            <a href="../ceo-find-detail/ceo-find-pw-phone.html">
                <img src="../img/phone2.png" alt="">
                <p>전화번호로 찾기</p>
            </a>
        </div>
        <div id="f_email" class="find">
            <a href="../ceo-find-detail/ceo-find-pw-email.html">
