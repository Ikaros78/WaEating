          ...
          <div class="input-form col-md-12">
            ...
            <form class="validation-form" novalidate>
              ...
              <div class="mb-3">
                ...
                <div class="form-floating mb-3">
                  <input type="tel" class="form-control" id="store_phone" placeholder="업체 전화번호 입력" required>
                ...
                <div class="form-floating mb-3">
                  <input type="text" class="form-control" id="strore_address" placeholder="업체 주소 입력" required>
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="file" class="form-control" id="business" accept=".jpg, .jpeg, .png, .pdf" required multiple>
                <div class="invalid-feedback">
                  사업자 등록증을 등록해주세요
                </div>
            </div>
