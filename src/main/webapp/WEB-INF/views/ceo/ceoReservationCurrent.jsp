    ...
    <section class="row container-fluid px-5">
      <aside class="float-start col-2 mt-4 ms-5 px-3">
        ...
        <div class="list-group list-group-flush border-top border-bottom">
          <!-- 메뉴 세부 제목 -->
          <a href="ceo_reservation_current.html" class="list-group-item list-group-item-action py-3 select">예약 현황 관리</a>
          <a href="ceo_reservation_list.html" class="list-group-item list-group-item-action py-3">예약 리스트 보기</a>
