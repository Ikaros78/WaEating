		...
		<div id="body">
            ...
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr class="rowClick">
                        <td class=details><c:out value="${ faq.faqNo }"/></td>
                        <td class=details><c:out value="${ faq.title }"/></td>
                        <td class=details><c:out value="${ faq.id }"/></td>
                        <td class=details><c:out value="${ faq.regDate }"/></td>
                    </tr>
                    </c:forEach>
                    </tbody>
                </table>
