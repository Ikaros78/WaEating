...
<head>
    ...
    <title>user_matziplist_location</title>
    <meta charset="utf-8">
    ...
    <section class="row container-fluid px-5">
      <aside class="float-start col-2 mt-4 ms-5 px-3">
        ...
        <div class="list-group list-group-flush border-top border-bottom">
          ...
          <a href="${ pageContext.servletContext.contextPath }/user/matziplist/location" class="list-group-item list-group-item-action py-3 select">지역별</a>
