 ...
 */
@WebServlet("/report/ceo/insert")
public class ReportSelectCeoInserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	
		
		request.getRequestDispatcher("/WEB-INF/views/report/ReportCeoInsert.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   path = "/WEB-INF/views/common/success.jsp";
		   request.setAttribute("success", "insertCeoReport");
	   } else {
