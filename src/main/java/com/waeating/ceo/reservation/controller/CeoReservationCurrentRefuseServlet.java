...
/**
 * Servlet implementation class CeoReservationRefuseServlet
 */
@WebServlet("/ceo/reservation_current_refuse")
public class CeoReservationCurrentRefuseServlet extends HttpServlet {
