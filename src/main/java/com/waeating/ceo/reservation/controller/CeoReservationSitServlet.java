...
/**
 * Servlet implementation class CeoReservationSitServlet
 */
@WebServlet("/ceo/reservation_current_sit")
public class CeoReservationSitServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		String recordNo = request.getParameter("recordNo");
		String useStatus = "complete";
