...
/**
 * Servlet implementation class AdminCompanyAccessServlet
 */
@WebServlet("/admin/company/access")
public class AdminCompanyAccessServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			request.setAttribute("message", "업체 승인 실패!");
